      ...
      <body class="bg-gray-100 flex items-center justify-center min-h-screen">
         <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                 <h2 class="text-2xl font-semibold text-indigo-700 mb-6 text-center">Créer un compte</h2>
                  <form action="index.php?uc=inscription&action=nouvelUtilisateur" method="POST">

            <div class="mb-4">
                  <label for="name" 
                  class="block mb-1 text-gray-600">Nom</label>
            ...
            <div class="mb-4">
                  <label for="firstname" 
                  class="block mb-1 text-gray-600">Prenom</label>
            ...
            <p class="text-sm text-center text-gray-500 mt-4"> Déjà inscrit ? 
                <a href="login.html" class="text-indigo-600 hover:underline">Se connecter</a> 
            </p>
        </div>
      </body>
</html>